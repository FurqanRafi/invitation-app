...
const Footer = () => {
    return (
        <footer className="w-full Mycontainer mt-10 ">
            <div className="max-w-7xl  mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
                ...
                <div className="text-center md:text-left  ">
                    ...
                    <div className="flex justify-center md:justify-start gap-3">
                        ...
                        <span className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">F</span>
                        <span className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">T</span>
                        <span className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">I</span>
                    </div>
                </div>

                {/* Menu */}
                <div className='lg:ml-10 ml-0'>
                    <h2 className={`${playfair.className} font-semibold text-lg lg:text-2xl mb-6`}>Menu</h2>
                    <ul className={`space-y-3 text-sm lg:text-lg font-medium flex  flex-col gap-2 text-[#3F3F3F] ${outfit.className}`}>
                        ...
                        <li><Link href="/gallery" className="hover:text-[#824D5D]">Gallery</Link></li>
                        <li><Link href="/contact" className="hover:text-[#824D5D]">Contact</Link></li>
                    </ul>
                </div>

                {/* Services */}
                <div>
                    <h2 className={`${playfair.className} font-semibold text-lg lg:text-2xl mb-6`}>Services</h2>
                    <ul className={`${outfit.className} space-y-3 text-sm text-[#3F3F3F] flex flex-col gap-2 lg:text-lg font-medium`}>
                        <li>Wedding Invitation</li>
                        <li>Birthday Invitation</li>
